...
class StatsService {
    ...
    static async getPixelBoardCount() {
        try {
            ...
            console.error("Erreur lors de la récupération du nombre de PixelBoards:", error);
            throw error;
        }
    }
    ...
    static async getPixelCount() {
        try {
            ...
            console.error("Erreur lors de la récupération du nombre de pixels:", error);
            throw error;
        }
    }
    ...
    static async getRecentBoards() {
        try {
            ...
            console.error("Erreur lors de la récupération des tableaux récents:", error);
            throw error;
        }
    }
}
